...
class AvailabilityBitmapTree {
    ...
    public:
        ...
        //----------------------------------------------------------
        void init(size_t leaf_bits);
        //----------------------------------------------------------
        void init(size_t leaf_bits, size_t planes);
        //----------------------------------------------------------
        void reset_all_set() noexcept;
        //----------------------------------------------------------
        void reset_all_set(size_t plane) noexcept;
        //----------------------------------------------------------
        void reset_all_clear() noexcept;
        //----------------------------------------------------------
        void reset_all_clear(size_t plane) noexcept;
        //----------------------------------------------------------
        void set(size_t bit_index) noexcept;
        //----------------------------------------------------------
        void set(size_t bit_index, size_t plane) noexcept;
        //----------------------------------------------------------
        void clear(size_t bit_index) noexcept;
        //----------------------------------------------------------
        void clear(size_t bit_index, size_t plane) noexcept;
        //----------------------------------------------------------
        ...
        //----------------------------------------------------------
        size_t leaf_bits() const noexcept { return m_leaf_bits; }
        //----------------------------------------------------------
        size_t planes() const noexcept { return m_planes; }
        //----------------------------------------------------------
    protected:
        //----------------------------------------------------------
        void reset() noexcept;
        //----------------------------------------------------------
        void move_from(AvailabilityBitmapTree& other) noexcept;
        //----------------------------------------------------------
        void build_layout();
        //----------------------------------------------------------
        ...
        //----------------------------------------------------------
        void set_bit(size_t plane, size_t level, size_t bit_index) noexcept;
        //----------------------------------------------------------
        void clear_bit(size_t plane, size_t level, size_t bit_index) noexcept;
        //----------------------------------------------------------
    ...
    private:
        //----------------------------------------------------------
        Mode m_mode;
        size_t m_leaf_bits, m_planes;
        std::atomic<uint64_t> m_single0, m_single1;
        //--------------------------
        size_t m_levels,  m_words_per_plane;
